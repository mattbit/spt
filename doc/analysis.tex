...
\begin{figure}[htbp]
  \subfloat[t = 0]{\includegraphics[width=0.5\linewidth]{img/03_000_sim.png}}
  \subfloat[t = 5]{\includegraphics[width=0.5\linewidth]{img/03_005_sim.png}}\\
  \subfloat[t = 10]{\includegraphics[width=0.5\linewidth]{img/03_010_sim.png}}
  \subfloat[t = 200]{\includegraphics[width=0.5\linewidth]{img/03_200_sim.png}}
